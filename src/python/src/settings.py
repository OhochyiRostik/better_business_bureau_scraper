...
PROXY_ENABLED = strtobool(os.getenv("PROXY_ENABLED", "True"))

USER_AGENT_RELEASE_DATE = '2023-11-01'
...
DOWNLOADER_MIDDLEWARES = {
    ...
    "middlewares.UpdateProxyMiddleware": 520,

    "middlewares.HttpProxyMiddleware": 543,

    # "scrapy.downloadermiddlewares.retry.RetryMiddleware": None,
    # "middlewares.ManyRequestsMiddleware": 560,
